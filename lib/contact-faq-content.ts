...
export const CONTACT_FAQ_SECTIONS: readonly ContactFaqSection[] = [
  {
    items: [
      ...
      },
      {
        ...
        answer: `Use Manage Your Subscription below or visit ${MANAGE_BILLING_URL} to update billing, switch plans, or cancel. You can also email support@pathpicker.com if you need help with your account.`,
      },
      {
    ...
    items: [
      {
        ...
        answer: `You can cancel anytime through your account settings at ${MANAGE_BILLING_URL} or by emailing support@pathpicker.com. Your subscription stays active until the end of your current billing cycle—no further charges after that. Cancel before your trial ends if you do not want to convert to a paid plan.`,
      },
      {
